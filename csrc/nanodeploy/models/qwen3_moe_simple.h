...
public:
    ...
    {
        return MoeExpertRunner::compute_contiguous(input, topk_idx, topk_weights, gate_up_w, down_w, hidden_size_);
    }
    ...
    {
        return MoeExpertRunner::compute_masked(recv_x, masked_m, expected_m, gate_up_w, down_w);
    }
