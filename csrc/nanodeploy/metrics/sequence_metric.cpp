...
SequenceMetric::SequenceMetric(const std::string& seq_id, int num_prompt_tokens):
...
std::shared_ptr<SequenceMetric> SequenceMetric::setstate(const std::tuple<std::string,
                                                                          std::optional<double>,
                                                                          std::optional<double>,
                                                                          std::optional<double>,
                                                                          std::optional<double>,
