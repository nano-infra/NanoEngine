...
void bind_sp_state_manager(py::module_& m)
{
    ...
    py::enum_<RoutingStrategy>(m, "RoutingStrategy")
        ...
        .value("LeastProjectedLoad", RoutingStrategy::LeastProjectedLoad)
        .export_values()
        .def_static("__class_getitem__",
                    [](const std::string& name) {
                        ...
                        if (name == "LeastProjectedLoad")
                            return RoutingStrategy::LeastProjectedLoad;
        ...
        .def_property_readonly_static("__members__", [](py::object /* self */) {
            ...
            m["LeastProjectedLoad"] = RoutingStrategy::LeastProjectedLoad;
            return m;
        });
