...
void bind_model_runner_utils(py::module_& m)
{
    ...
    py::class_<DecodeMetadata>(m, "DecodeMetadata")
        ...
        .def_readonly("use_sp_a2a", &DecodeMetadata::use_sp_a2a)
        ...
        .def_readonly("q_native_offsets", &DecodeMetadata::q_native_offsets)
        .def_readonly("q_native_slice_fill", &DecodeMetadata::q_native_slice_fill)
        .def_readonly("q_native_gather_indices", &DecodeMetadata::q_native_gather_indices);
