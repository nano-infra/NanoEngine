...
import flatbuffers
from dlengine._cpp import deserialize, SamplingParams, Sequence, serialize
from dlengine.fbs import (
...
class TestSerialization(unittest.TestCase):
    def test_round_trip(self):
        ...
        # Need to use C++ enum
        from dlengine._cpp import SequenceStatus as CppSequenceStatus
    ...
    def test_manual_flatbuffer_construction(self):
        ...
        import dlengine.fbs.SamplingParams as SamplingParamsModule

        # Helper to use module functions
        import dlengine.fbs.Sequence as SequenceModule
        import dlengine.fbs.SequenceList as SequenceListModule
