...
from dlengine.runtime.context.batch import Context, get_batch_context, set_batch_context
...
from dlengine.runtime.context.expert import ExpertContext, set_expert_context
from dlengine.runtime.context.graph import (
    DecodeGraphContext,
    ...
    def capture(self, model, cache_ctx):
        ...
        for master_bs in reversed(self._bs_list):
            ...
            if self._is_dsv4:
                ...
                from dlengine.runtime.models.deepseek_v4.deepseek_v4 import (
                    DeepseekV4Attention,
                )
