...
from dlengine.runtime.models.deepseek_v2.deepseek_v2 import DeepseekV2Attention
    ...
    def __init__(self, config, layer_idx: int, cache_layer_idx: int):
        ...
        def gated_o_proj(x, *args, **kwargs):
            ...
            if gate_input is not None:
                from dlengine.runtime.kernel.triton.generic.sigmoid_mul import (
                    sigmoid_mul_triton,
                )
...
class AttentionResidual:
    ...
    def aggregate(
        ...
        if self.valid:
            from dlengine.runtime.kernel.jit.sgl.attn_res import (
...
class KimiMoE(nn.Module):
    ...
    def forward(self, x: torch.Tensor, prefix: Optional[torch.Tensor] = None):
        ...
        if prefix is not None:
            from dlengine.runtime.kernel.jit.sgl.add3 import add3, covered
