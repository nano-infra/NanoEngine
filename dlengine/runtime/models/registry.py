...
def _qwen3_cls():
    from dlengine.runtime.models.qwen3.qwen3 import Qwen3ForCausalLM

    return Qwen3ForCausalLM


def _qwen3_moe_cls():
    from dlengine.runtime.models.qwen3_moe.qwen3_moe import Qwen3MoeForCausalLM

    return Qwen3MoeForCausalLM


def _qwen3_5_cls():
    from dlengine.runtime.models.qwen3_5.qwen3_5 import Qwen3_5ForConditionalGeneration

    return Qwen3_5ForConditionalGeneration


def _qwen3_5_moe_cls():
    from dlengine.runtime.models.qwen3_5_moe.qwen3_5_moe import (
...
def _deepseek_v2_cls():
    from dlengine.runtime.models.deepseek_v2.deepseek_v2 import DeepseekV2ForCausalLM

    return DeepseekV2ForCausalLM


def _deepseek_v4_cls():
    from dlengine.runtime.models.deepseek_v4.deepseek_v4 import DeepseekV4ForCausalLM
...
def _gemma4_cls():
    from dlengine.runtime.models.gemma4.gemma4 import Gemma4ForCausalLM

    return Gemma4ForCausalLM


def _qwen3_5_mtp_cls():
    from dlengine.runtime.models.qwen3_5_moe.qwen3_5_moe_mtp import Qwen3_5MTP
