...
def _m_grouped_fp8_gemm_nt_masked(deep_gemm, a, b, d, masked_m, expected_m) -> None:
...
class HopperDistributedRoutedExperts(DistributedRoutedExpertsBase):
    ...
    def _compute_local_prefill(
        ...
        if self.is_fp8:
            from dlengine.runtime.kernel.triton.hopper.fp8 import (
                per_token_group_quant_fp8,
            )
            from dlengine.runtime.kernel.triton.hopper.fused_moe_v3 import fused_moe_v3
    ...
    def _compute_decode_ep_mega(
        ...
        from dlengine.runtime.kernel.triton.hopper.fp8 import per_token_group_quant_fp8
