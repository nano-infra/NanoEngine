"""FA4 prefill + TRT-LLM paged decode GQA attention for NVIDIA Blackwell GPUs.

Dense MLA on Blackwell now lives in ``backends/mla/trtllm.py``
(``TrtllmMlaAttention``); this module is GQA-only.
"""
...
class Fa4Attention(Fa3Attention):
    ...
    def __init__(self, *args, attention_type: str = "GQA", **kwargs) -> None:
