...
static SGL_DEVICE void cp_async_bulk_tensor_2d_load_2sm(uint32_t           dst_smem,
...
static SGL_DEVICE void cp_async_bulk_tensor_2d_load_multicast(uint32_t           dst_smem,
                                                              const CUtensorMap* tmap,
                                                              int32_t            x,
                                                              int32_t            y,
                                                              uint64_t*          bar,
...
static SGL_DEVICE void cp_async_bulk_tensor_2d_load_multicast_cg1(uint32_t           dst_smem,
                                                                  const CUtensorMap* tmap,
                                                                  int32_t            x,
                                                                  int32_t            y,
                                                                  uint64_t*          bar,
                                                                  ...
                                                                  uint64_t           cache_hint     = 0x0ULL)
{
    ...
    asm volatile("cp.async.bulk.tensor.2d.cta_group::1.shared::cluster.global"
                 ".mbarrier::complete_tx::bytes.multicast::cluster.L2::cache_hint"
                 " [%0], [%1, {%4, %5}], [%2], %3, %6;" ::"r"(dst_smem),
                 "l"(tmap),
                 "r"(mbar_addr),
