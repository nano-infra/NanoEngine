...
// Vendored from sglang/python/sglang/jit_kernel/csrc/kvcacheio/hicache.cuh.
// Local in-process HiCache KV copy kernel used as the non-RDMA fast path.
...
struct HiCacheKernel {
    ...
    static void run_one_mla(const tvm::ffi::TensorView cache_dst,
                            const tvm::ffi::TensorView indices_dst,
    ...
    static void run_all_mla(const tvm::ffi::TensorView ptr_dst,
                            const tvm::ffi::TensorView indices_dst,
