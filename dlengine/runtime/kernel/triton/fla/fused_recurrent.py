...
from dlengine.runtime.kernel.triton.fla.op import exp
from dlengine.runtime.kernel.triton.fla.utils import input_guard
...
def fused_recurrent_gated_delta_rule_packed_decode(
    ...
    if use_qk_l2norm_in_kernel:
        from dlengine.runtime.kernel.triton import kda_packed_decode as kda_decode_cuda
...
def fused_recurrent_kda_packed_decode(
    ...
    if use_qk_l2norm_in_kernel:
        try:
            from dlengine.runtime.kernel.triton import (
                kda_packed_decode as kda_decode_cuda,
            )
        except ImportError:
            kda_decode_cuda = None

        if kda_decode_cuda is not None and kda_decode_cuda.covered(
            mixed_qkv,
            a,
            b,
            A_log,
