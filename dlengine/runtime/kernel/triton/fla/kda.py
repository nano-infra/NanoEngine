...
from dlengine.runtime.kernel.triton.fla.chunk_delta_h import (
    chunk_gated_delta_rule_fwd_h,
)
from dlengine.runtime.kernel.triton.fla.chunk_intra import chunk_kda_fwd_intra
from dlengine.runtime.kernel.triton.fla.cumsum import chunk_local_cumsum
from dlengine.runtime.kernel.triton.fla.fused_recurrent import (
    fused_recurrent_gated_delta_rule_fwd_kernel,
)
from dlengine.runtime.kernel.triton.fla.index import prepare_chunk_indices
from dlengine.runtime.kernel.triton.fla.l2norm import l2norm_fwd
from dlengine.runtime.kernel.triton.fla.op import exp, exp2, log
from dlengine.runtime.kernel.triton.fla.utils import (
...
if is_intel:
    raise RuntimeError("NanoDeploy KDA Triton kernels currently require NVIDIA GPUs.")
