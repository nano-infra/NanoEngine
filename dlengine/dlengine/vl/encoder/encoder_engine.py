...
class EncoderEngine:
    ...
    def __init__(self, config: EncoderConfig) -> None:
        ...
        # --- ZMQ encode service (dlengine-router connects here) ---
    ...
    # ------------------------------------------------------------------
    # ZMQ encode service (dlengine-router → EncoderEngine)
    # ------------------------------------------------------------------

    def _start_zmq_encode_service(self):
        """Start a ZMQ ROUTER socket to accept encode requests from dlengine-router.
