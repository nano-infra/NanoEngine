...
# Source (vendored under dlengine/kernel/jit/sgl):
...
try:
    from dlengine.models.deepseek_v4.index_kernels import (
...
if _DSV4_FUSED_KERNELS:
    try:
        from dlengine.models.deepseek_v4.compress_kernels import (
...
if _DSV4_FUSED_KERNELS:
    try:
        from dlengine.kernel.tilelang.sgl import mhc_pre as _SGL_MHC_PRE
    except Exception:
        _SGL_MHC_PRE = None
else:
