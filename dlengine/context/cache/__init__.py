...
from dlengine.context.cache._allocator import KVCacheAllocatorMixin
...
from dlengine.context.cache.csa import get_csa_context
from dlengine.context.cache.gdn import get_gdn_context, initialize_gdn_cache_state
from dlengine.context.cache.gqa import get_gqa_context
from dlengine.context.cache.hca import get_hca_context
from dlengine.context.cache.hisparse import get_hisparse_context
from dlengine.context.cache.indexer import get_indexer_block_bytes, get_indexer_context
    ...
    def __post_init__(self):
        ...
        if is_mla_hisparse:
            host_budget_bytes = int(
                max(0.0, float(self.host_utilization_per_device or 0.0)) * 1024**3
            )
