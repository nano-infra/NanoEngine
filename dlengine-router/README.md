...
1. On startup, dlengine-router queries **dlslime-ctrl** for the Redis address (`/get_redis_address`).
...
[engine]
mode = "Disaggregated"
ctrl_address = "http://10.0.0.1:4479"
...
| `engine.ctrl_address` | **Required.** dlslime-ctrl HTTP endpoint for Redis URL retrieval and engine listing                        |

Optional environment variable:

- `DLSLIME_CTRL_SCOPE` — Redis key prefix for multi-tenant isolation (default: empty).
