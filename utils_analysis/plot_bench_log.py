...
def parse_and_plot_log(file_path):
    ...
    print(
        f"Parse complete. Generating charts for {decode_step_count} steps. Total Ranks found: {num_ranks}"
    )
    ...
    # Legend outside
    ax1.legend(
        loc="center left", bbox_to_anchor=(1, 0.5), fontsize="small", title="Ranks"
    )
