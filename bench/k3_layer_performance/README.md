...
The next pass should add production paged-cache MLA Decode, Dense FFN Prefill/Decode, MegaMoE Decode batch scaling, and Nsight counters for a formal roofline classification.
