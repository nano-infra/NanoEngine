...
py::object alloc_dlpack_tensor(dlslime::NVShmemContext &self, size_t size,
                               size_t alignment) {
  ...
  tensor.data = ptr;
  tensor.device = DLDevice{.device_type = DLDeviceType::kDLCUDA,
...
PYBIND11_MODULE(_slime_c, m) {
  ...
  py::class_<dlslime::Assignment>(m, "Assignment")
      ...
      .def(py::init<const uintptr_t &, const uintptr_t &, uint64_t, uint64_t,
                    uint64_t>());

  py::class_<dlslime::device::DeviceSignal,
             std::shared_ptr<dlslime::device::DeviceSignal>>(m, "DeviceSignal")
      .def("wait", &dlslime::device::DeviceSignal::wait_comm_done_cpu);

#ifdef BUILD_RDMA
  py::class_<dlslime::RDMAContext, std::shared_ptr<dlslime::RDMAContext>>(
      m, "RDMAContext")
      .def(py::init<>())
  ...
  py::class_<dlslime::SendFuture, std::shared_ptr<dlslime::SendFuture>>(
      m, "SlimeSendFuture")
      .def("wait", &dlslime::SendFuture::wait,
           py::call_guard<py::gil_scoped_release>());
  py::class_<dlslime::RecvFuture, std::shared_ptr<dlslime::RecvFuture>>(
      m, "SlimeRecvFuture")
      .def("wait", &dlslime::RecvFuture::wait,
           py::call_guard<py::gil_scoped_release>());
  py::class_<dlslime::ReadWriteFuture,
             std::shared_ptr<dlslime::ReadWriteFuture>>(m,
                                                        "SlimeReadWriteFuture")
      .def("wait", &dlslime::ReadWriteFuture::wait,
           py::call_guard<py::gil_scoped_release>());
  py::class_<dlslime::ImmRecvFuture, std::shared_ptr<dlslime::ImmRecvFuture>>(
      m, "SlimeImmRecvFuture")
      .def("wait", &dlslime::ImmRecvFuture::wait,
           py::call_guard<py::gil_scoped_release>())
      .def("imm_data", &dlslime::ImmRecvFuture::immData,
           py::call_guard<py::gil_scoped_release>());
  py::class_<dlslime::RDMAEndpoint, std::shared_ptr<dlslime::RDMAEndpoint>>(
      m, "RDMAEndpoint")
      .def(py::init<std::shared_ptr<dlslime::RDMAContext>, size_t,
                    std::shared_ptr<dlslime::RDMAWorker>>(),
           py::arg("context"), py::arg("num_qp") = 1,
           py::arg("worker") = nullptr)
      .def(py::init<std::string, int32_t, std::string, size_t,
                    std::shared_ptr<dlslime::RDMAWorker>>(),
           py::arg("device_name") = "", py::arg("ib_port") = 1,
           py::arg("link_type") = "RoCE", py::arg("num_qp") = 1,
           py::arg("worker") = nullptr)
      .def("connect", &dlslime::RDMAEndpoint::connect,
           py::call_guard<py::gil_scoped_release>())
      .def("endpoint_info", &dlslime::RDMAEndpoint::endpointInfo)

      .def("register_memory_region",
           &dlslime::RDMAEndpoint::registerOrAccessMemoryRegion,
           py::arg("mr_key"), py::arg("data_ptr"), py::arg("offset"),
           py::arg("length"), py::call_guard<py::gil_scoped_release>())
      .def("register_remote_memory_region",
           &dlslime::RDMAEndpoint::registerOrAccessRemoteMemoryRegion,
           py::call_guard<py::gil_scoped_release>())

      // --- Msg Operations ---
      .def("send", &dlslime::RDMAEndpoint::send, py::arg("chunk"),
           py::arg("stream_handler") = nullptr,
           py::call_guard<py::gil_scoped_release>())

      .def("recv", &dlslime::RDMAEndpoint::recv, py::arg("chunk"),
           py::arg("stream_handler") = nullptr,
           py::call_guard<py::gil_scoped_release>())

      // --- IO Operations ---
      .def("read", &dlslime::RDMAEndpoint::read, py::arg("assign"),
           py::arg("stream") = nullptr,
           py::call_guard<py::gil_scoped_release>())
      .def("write", &dlslime::RDMAEndpoint::write, py::arg("assign"),
           py::arg("stream") = nullptr,
           py::call_guard<py::gil_scoped_release>())
      .def("write_with_imm", &dlslime::RDMAEndpoint::writeWithImm,
           py::arg("assign"), py::arg("imm_data") = 0,
           py::arg("stream") = nullptr,
           py::call_guard<py::gil_scoped_release>())
      .def("imm_recv", &dlslime::RDMAEndpoint::immRecv,
           py::arg("stream") = nullptr,
           py::call_guard<py::gil_scoped_release>())

      .def("process", &dlslime::RDMAEndpoint::process,
           py::call_guard<py::gil_scoped_release>());

  // =========================================================================
  // RDMA Worker (Scheduler)
  // =========================================================================
  py::class_<dlslime::RDMAWorker, std::shared_ptr<dlslime::RDMAWorker>>(
      m, "RDMAWorker")
      ...
      .def("add_endpoint", &dlslime::RDMAWorker::addEndpoint,
           py::arg("endpoint"));
...
#ifdef BUILD_NVSHMEM
  py::class_<dlslime::NVShmemContext, std::shared_ptr<dlslime::NVShmemContext>>(
      m, "NVShmemContext")
      .def(py::init<const int, const int, const int>())
      .def("connect_full_mesh", &dlslime::NVShmemContext::connectFullMesh)
      .def("get_local_nvshmem_unique_id",
           &dlslime::NVShmemContext::getLocalNVShmemUniqueId)
      .def("register_memory_region",
           &dlslime::NVShmemContext::registerMemoryRegion)
...
#ifdef BUILD_NVLINK
  py::class_<dlslime::NVLinkFuture, std::shared_ptr<dlslime::NVLinkFuture>>(
      m, "SlimeNVLinkFuture")
      .def("wait", &dlslime::NVLinkFuture::wait,
           py::call_guard<py::gil_scoped_release>());
  py::class_<dlslime::NVLinkEndpoint>(m, "NVLinkEndpoint")
      .def(py::init<>())
      .def("register_memory_region",
           &dlslime::NVLinkEndpoint::register_memory_region, py::arg("mr_key"),
           py::arg("data_ptr"), py::arg("offset"), py::arg("length"))
      .def("register_remote_memory_region",
      ...
      .def("read", &dlslime::NVLinkEndpoint::read, py::arg("assign"),
           py::arg("stream") = nullptr,
           py::call_guard<py::gil_scoped_release>());
#endif
  ...
  py::class_<dlslime::AllToAllIntraLLBuffer>(m, "AllToAllIntraLLBuffer")
      ...
      .def("connect_full_mesh",
           &dlslime::AllToAllIntraLLBuffer::connectFullMesh)
      .def("get_local_buffer", &dlslime::AllToAllIntraLLBuffer::getLocalBuffer)
      .def("get_buffer_size_hint",
           &dlslime::AllToAllIntraLLBuffer::get_buffer_size_hint)
      .def("set_max_bs", &dlslime::AllToAllIntraLLBuffer::setMaxBs)
      .def("all_to_all_ll", &dlslime::AllToAllIntraLLBuffer::allToAllLL2D,
           py::arg("x"), py::arg("is_transpose") = false,
           py::arg("mask") = py::none(), py::arg("offsets") = py::none(),
