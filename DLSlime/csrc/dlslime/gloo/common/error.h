...
#define GLOO_ERROR_MSG(...) ::gloo::MakeString("[", __FILE__, ":", __LINE__, "] ", __VA_ARGS__)
...
struct InvalidOperationException: public ::gloo::Exception {
    ...
    explicit InvalidOperationException(const std::string& msg): ::gloo::Exception(msg) {}
};

#define GLOO_THROW_INVALID_OPERATION_EXCEPTION(...) throw ::gloo::InvalidOperationException(GLOO_ERROR_MSG(__VA_ARGS__))
...
#define GLOO_THROW_IO_EXCEPTION(...) throw ::gloo::IoException(GLOO_ERROR_MSG(__VA_ARGS__))
