...
class UnboundBuffer: public ::gloo::transport::UnboundBuffer, public BufferHandler {
public:
    UnboundBuffer(const std::shared_ptr<Context>& context, void* ptr, size_t size);
    ...
    void recv(std::vector<int> srcRanks, uint64_t slot, size_t offset, size_t nbytes) override;
