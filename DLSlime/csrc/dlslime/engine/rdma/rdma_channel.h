...
enum RDMAChannelState { Initialized, Connected, Destroyed };
...
public:
  ...
  int32_t init(std::shared_ptr<RDMAContext> ctx, size_t num_qp,
               int32_t inline_size);
  ...
  inline int32_t num_channel() { return qp_.size(); }
