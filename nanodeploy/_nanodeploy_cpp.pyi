...
class Block:
    ...
    def reset(self) -> None:
        ...
    def update(self, arg0: typing.SupportsInt, arg1: collections.abc.Sequence[typing.SupportsInt]) -> None:
        ...
    @property
...
class BlockContextSlot:
    ...
    __members__: typing.ClassVar[dict[str, BlockContextSlot]]  # value = {'ACTIVE': <BlockContextSlot.ACTIVE: 0>, 'MIGRATE': <BlockContextSlot.MIGRATE: 1>, 'SWAP': <BlockContextSlot.SWAP: 2>}
...
class BlockLocationList:
    ...
    def __ne__(self, arg0: BlockLocationList) -> bool:
        ...
    @typing.overload
    def __setitem__(self, arg0: typing.SupportsInt, arg1: tuple[typing.SupportsInt, typing.SupportsInt]) -> None:
        ...
    @typing.overload
    ...
    def extend(self, L: collections.abc.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: typing.SupportsInt, x: tuple[typing.SupportsInt, typing.SupportsInt]) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
...
class BlockManager:
    @staticmethod
    def compute_hash(token_ids: collections.abc.Sequence[typing.SupportsInt], prefix: typing.SupportsInt = -1) -> int:
        ...
    def __init__(self, engine_id: str, sp_idx: typing.SupportsInt, num_blocks: typing.SupportsInt, block_size: typing.SupportsInt) -> None:
        ...
...
class DecodeMetadata:
    ...
    def context_lens_flat(self) -> list[int]:
        ...
    @property
    def context_lens_for_attn(self) -> list[int]:
        ...
    @property
    ...
    def q_slice_fill(self) -> list[int]:
        ...
    @property
    def q_slice_get(self) -> list[int]:
        ...
    @property
    def res_slice_fill_to_buffer_input(self) -> list[int]:
        ...
    @property
    def res_slice_fill_to_buffer_output(self) -> list[int]:
        ...
    @property
    def res_slice_get_to_buffer_input(self) -> list[int]:
        ...
    @property
    def res_slice_get_to_buffer_output(self) -> list[int]:
        ...
    @property
    def res_to_buffer_input_mask(self) -> list[int]:
        ...
    @property
    def res_to_buffer_output_mask(self) -> list[int]:
        ...
    @property
...
class DefaultListDict:
    ...
    def __init__(self) -> None:
        ...
    def __setitem__(self, arg0: typing.SupportsInt, arg1: collections.abc.Iterable) -> None:
        ...
class MigrationMap:
    ...
    def __len__(self) -> int:
        ...
    def __setitem__(self, arg0: str, arg1: tuple[typing.Sequence, typing.SupportsInt]) -> None:
        ...
    def items(self) -> list:
        ...
    def keys(self) -> list:
...
class RoutingStrategy:
    ...
    LeastCache: typing.ClassVar[RoutingStrategy]  # value = <RoutingStrategy.LeastCache: 2>
    RoundRobin: typing.ClassVar[RoutingStrategy]  # value = <RoutingStrategy.RoundRobin: 0>
    __members__: typing.ClassVar[dict[str, RoutingStrategy]]  # value = {'RoundRobin': <RoutingStrategy.RoundRobin: 0>, 'LeastBatch': <RoutingStrategy.LeastBatch: 1>, 'LeastCache': <RoutingStrategy.LeastCache: 2>}
    @staticmethod
...
class SPStateManager:
    ...
    def __init__(self, engine_id: str, attention_sp: typing.SupportsInt, num_kvcache_blocks: typing.SupportsInt, kvcache_block_size: typing.SupportsInt, max_num_seqs: typing.SupportsInt, max_num_batched_tokens: typing.SupportsInt) -> None:
        ...
...
class ScheduleResult:
    ...
    def dp_seqs(self) -> list[list[typing.Sequence]]:
        ...
    @dp_seqs.setter
    def dp_seqs(self, arg0: collections.abc.Sequence[collections.abc.Sequence[typing.Sequence]]) -> None:
        ...
    @property
    def dp_sp_seqs(self) -> list[list[typing.Sequence]]:
        ...
    @dp_sp_seqs.setter
    def dp_sp_seqs(self, arg0: collections.abc.Sequence[collections.abc.Sequence[typing.Sequence]]) -> None:
        ...
    @property
    def filtered_dp_sp_seqs(self) -> list[list[typing.Sequence]]:
        ...
    @filtered_dp_sp_seqs.setter
    def filtered_dp_sp_seqs(self, arg0: collections.abc.Sequence[collections.abc.Sequence[typing.Sequence]]) -> None:
        ...
    @property
    def sp_q_matrix(self) -> list[list[list[int]]]:
        ...
    @property
    def sp_recv_counts(self) -> list[list[int]]:
        ...
    @property
    def sp_send_counts(self) -> list[list[int]]:
        ...
    @property
    def waiting_head_blocks(self) -> int:
        ...
    @property
    def waiting_total_blocks(self) -> int:
        ...
class Scheduler:
    routing_strategy: RoutingStrategy
    ...
    def to_be_migrated(self, arg0: collections.abc.Mapping[typing.SupportsInt, tuple[typing.Sequence, typing.SupportsInt]]) -> None:
        ...
class Sequence:
    ...
    def __getitem__(self: typing.Sequence, arg0: typing.Any) -> typing.Any:
        ...
    def __getstate__(self: typing.Sequence) -> tuple[int, int, int, typing.Annotated[list[BlockContext], "FixedSize(3)"], float, list[int]]:
        ...
    def __init__(self: typing.Sequence, token_ids: collections.abc.Sequence[typing.SupportsInt], temperature: typing.SupportsFloat = 1.0, max_tokens: typing.SupportsInt = 256, ignore_eos: bool = False) -> None:
        ...
    def __len__(self: typing.Sequence) -> int:
        ...
    def __setstate__(self: typing.Sequence, arg0: tuple[typing.SupportsInt, typing.SupportsInt, typing.SupportsInt, typing.Annotated[collections.abc.Sequence[BlockContext], "FixedSize(3)"], typing.SupportsFloat, collections.abc.Sequence[typing.SupportsInt]]) -> None:
        ...
    def active(self: typing.Sequence, engine_id: str, attention_sp: typing.SupportsInt, attention_dp: typing.SupportsInt) -> int:
        ...
    ...
    def block_ctx(self: typing.Sequence, slot: BlockContextSlot = ...) -> BlockContext:
        ...
    def block_table(self: typing.Sequence, slot: BlockContextSlot, sp_idx: typing.SupportsInt = 0) -> BlockIdList:
        ...
    def context_len(self: typing.Sequence, engine_id: BlockContextSlot, sp_idx: typing.SupportsInt | None = None) -> int:
        ...
    def dp_idx(self: typing.Sequence, slot: BlockContextSlot) -> int:
        ...
    def last_block_num_tokens(self: typing.Sequence, slot: BlockContextSlot, sp_idx: typing.SupportsInt) -> int:
        ...
...
class SequenceMetric:
    def __getstate__(self) -> tuple[int, float | None, float | None, float | None, float | None, float | None, float | None, float | None, int, int, list[float]]:
        ...
    def __init__(self, seq_id: typing.SupportsInt, num_prompt_tokens: typing.SupportsInt = 0) -> None:
        ...
    def __setstate__(self, arg0: tuple[typing.SupportsInt, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsFloat | None, typing.SupportsInt, typing.SupportsInt, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
    ...
    def itl_samples(self) -> list[float]:
        ...
    @itl_samples.setter
    def itl_samples(self, arg0: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    @property
...
class SequenceStatus:
    ...
    TO_BE_MIGRATED: typing.ClassVar[SequenceStatus]  # value = <SequenceStatus.TO_BE_MIGRATED: 3>
    WAITING: typing.ClassVar[SequenceStatus]  # value = <SequenceStatus.WAITING: 0>
    __members__: typing.ClassVar[dict[str, SequenceStatus]]  # value = {'WAITING': <SequenceStatus.WAITING: 0>, 'RUNNING': <SequenceStatus.RUNNING: 1>, 'FINISHED': <SequenceStatus.FINISHED: 2>, 'TO_BE_MIGRATED': <SequenceStatus.TO_BE_MIGRATED: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class ServerMetric:
    ...
    def add_completed_request(self) -> None:
        ...
    def add_tokens(self, num_prompt: typing.SupportsInt = 0, num_generated: typing.SupportsInt = 0) -> None:
        ...
    def get_metric_report(self, include_detailed: bool = False) -> str:
        ...
    def get_summary(self) -> dict:
        ...
    def record_decode_throughput(self, num_tokens: typing.SupportsInt, duration: typing.SupportsFloat) -> None:
        ...
    def record_prefill_throughput(self, num_tokens: typing.SupportsInt, duration: typing.SupportsFloat) -> None:
        ...
    def update_running_requests(self, count: typing.SupportsInt) -> None:
        ...
    def update_sp_stats(self, sp_send_counts: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]], sp_recv_counts: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]) -> None:
        ...
    def update_token_usage(self, dp_idx: typing.SupportsInt, num_tokens: typing.SupportsInt) -> None:
        ...
    def update_waiting_blocks(self, head_blocks: typing.SupportsInt, total_blocks: typing.SupportsInt) -> None:
        ...
    ...
    def decode_throughput_samples(self, arg0: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    @property
    ...
    def num_running_requests(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def num_waiting_head_blocks(self) -> int:
        ...
    @num_waiting_head_blocks.setter
    def num_waiting_head_blocks(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    ...
    def num_waiting_requests(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def num_waiting_total_blocks(self) -> int:
        ...
    @num_waiting_total_blocks.setter
    def num_waiting_total_blocks(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def prefill_throughput_samples(self) -> list[float]:
        ...
    @prefill_throughput_samples.setter
    def prefill_throughput_samples(self, arg0: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    @property
    ...
    def token_usage_by_dp(self, arg0: collections.abc.Mapping[typing.SupportsInt, typing.SupportsInt]) -> None:
        ...
    @property
...
def postprocess_sequences(worker_states: ..., std: ..., dp_sp_seqs: collections.abc.Sequence[collections.abc.Sequence[typing.Sequence]], dp_sp_token_ids: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]], eos_id: typing.SupportsInt, is_prefill: bool, update_metrics: bool = True, thread_pool: ... = None) -> list[tuple[typing.Sequence, int]]:
    ...
def prepare_decode_cpp(dp_seqs: collections.abc.Sequence[typing.Sequence], sp_rank: typing.SupportsInt, sp_size: typing.SupportsInt, block_size: typing.SupportsInt, max_num_seqs: typing.SupportsInt, max_num_send_recv_seqs: typing.SupportsInt) -> DecodeMetadata:
    ...
