...
from nanoccl import _nanoccl_c
from nanoccl.buffer.inter.init_nvshmem import setup_nvshmem_env
...
class AllGatherInterLLBuffer:
    def __init__(
        ...
        self._buffer = self.buffer = _nanoccl_c.AllGatherInterLLBuffer(
            self.bs,
            self.msg_size,
            self.dtype,
            self.world_size,
